      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center max-w-6xl mx-auto">
          ...
          <div className="space-y-6">
            ...
            <p className="font-body text-lg text-muted-foreground leading-relaxed">I love turning creative ideas into interactive, user-friendly experiences. I'm driven by curiosity, continuous learning, and a passion for futuristic design.<span className="text-primary"> HTML</span>, 
